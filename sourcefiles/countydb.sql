DROP DATABASE IF EXISTS County2;
CREATE DATABASE County2;
...
-- Insert data into County2db

INSERT INTO Contact VALUES
('10001','Mary','E','Smith','Mrs',null,'Clerk','Finance','Mary.Smith@County2.ny.us','www.fakeCounty2.ny.us','Mary.Smith','1960-06-22',null,1,null,null,'Genesee County2');
INSERT INTO Contact VALUES
('10002','Jim','T','Martin','Mr',null,'Director','Finance','Jim.Martin@County2.ny.us','www.fakeCounty2.ny.us','Jim.Martin','1954-08-19',null,1,null,null,'Genesee County2');
INSERT INTO County2.contact (contactID, firstname, lastname, suffix_description, title_description, jobtitle, email, url, Birthday, co_worker, companyname) VALUES ('10003', 'Jim', 'Bucki', 'Mr.', 'Java Programmer', 'Programmer', 'JMBucki@xyzCounty2.com', 'www.exzCounty2.ny.us', '1962-04-28', '1','GCC');
INSERT INTO County2.contact (contactID, firstname, middleinitial, lastname, suffix_description, title_description, jobtitle, department, email, url, birthday, co_worker, personal,companyname) VALUES ('10004', 'Elissa', '', 'Weeden', 'Mrs.', 'RIT Professor', 'DBMA', 'IST', 'eweeden@yahoo.com', 'http://www.ist.rit.edu/people/people.php', '1975-08-08', '1', '1','RIT');
INSERT INTO County2.contact (contactID, firstname, middleinitial, lastname, suffix_description, title_description, department, email, url, birthday, co_worker, personal,companyname) VALUES ('10005', 'Jim', 'R', 'Habermas', 'Mr.', 'Lecturer', 'IST', 'jrhabermas@gmail.com', 'http://jimhabermas.com', '1962-04-28', 1, 1,'RIT');
INSERT INTO County2.contact (contactID, firstname, lastname, suffix_description, title_description, jobtitle, email, birthday, personal, companyname) VALUES ('10006', 'Bill', 'Streetman', 'Mr.', 'Engineer', 'Engineer', 'bstreetman@yahoo.com', '1957-04-20', '1', 'GE');
...
select contactID, firstname AS 'First Name', lastname AS 'Last Name', TelephoneInfo.phone_number AS 'Phone Number' from County2.contact join County2.ContactNumber using (contactID)   join County2.telephoneinfo using (phone_number) group by contactID, phone_number;


select contactID, firstname AS 'First Name', lastname AS 'Last Name', group_concat(County2.telephoneinfo.phone_number separator' | ') from County2.contact  join   ContactNumber using (contactID)   join County2.telephoneinfo using (phone_number) group by contactID;

select contactID, firstname AS 'First Name', lastname AS 'Last Name', group_concat(County2.telephoneinfo.phone_number, " " ,County2.telephoneinfo.phonetype_description separator' | ') as "Phone" from County2.contact  join   ContactNumber using (contactID)   join County2.telephoneinfo using (phone_number) group by contactID;
...
INSERT INTO County2.company(companyname,company_url,company_phone,address_line1,city,state,zip_postalcode,country_region) VALUES ('Paychex', 'http://www.pachex.com', '(585)387-6200', '911 Panorama Trail South', 'Rochester', 'NY', '14625', 'Monroe');
INSERT INTO County2.company(companyname,company_url,company_phone,address_line1,address_line2,city,state,zip_postalcode,parent_companyname) VALUES ('Bentrac', 'http://www.bentrac.com', '(877)645-4342', 'Paychex Benefit Technologies, Inc.', '2385 Northside Drive', 'San Diego', 'CA', '92108', 'Paychex');
INSERT INTO County2.company(companyname,company_url,company_phone,address_line1,city,state,zip_postalcode,country_region) VALUES ('RIT', 'http://www.rit.edu', '(585)475-2411', '1 Lomb Memorial Drive', 'Rochester', 'NY', '14623', 'Monroe');
INSERT INTO County2.company(companyname,company_url,company_phone,address_line1,city,state,zip_postalcode,country_region) VALUES ('Genesee County2', 'http://fakeCounty2.ny.us', '(585)343-4099', '5 Main Street', 'Batavia', 'NY', '14020', 'Genesee');
INSERT INTO `County2`.`company` (`companyname`, `company_url`, `company_phone`, `address_line1`, `address_line2`, `city`, `state`, `zip_postalcode`, `country_region`) VALUES ('GCC', 'http://www.genesee.edu', '(585)343-0055', '1 College Rd', '', 'Batavia', 'NY', '14020', 'Genesee.edu');
INSERT INTO `County2`.`company` (`companyname`, `company_url`) VALUES ('GE', 'http://www.ge.com');
