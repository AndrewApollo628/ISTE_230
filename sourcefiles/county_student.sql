...
-- convert N:M to two 1:N and N:1
...
'Last Name', 
group_concat(county.telephoneinfo.phone_number, " " ,county.telephoneinfo.phonetype_description separator ' | ') as "Phone Numbers" from county.contact  join   ContactNumber using (contactID)   join county.telephoneinfo using (phone_number) group by contactID;
